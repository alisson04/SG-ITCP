...
public class NotaMaturidadeDAO extends DaoGenerico<NotaMaturidade> {
    ...
    public void excluirEptDao(NotaMaturidade obj){
        excluirGenerico(obj);
    }
    
    public List<NotaMaturidade> listarTodosEptsDao(List<Empreendimento> listaEpt) {
        String PU = "sigitecPU";
    ...
    public long contarLinhasDAO(){
        return contarLinhasGenerico("NotaMaturidade");
    }
}
